...
class ChemicalMass a where
     getElementalComposition :: a -> ChemicalFormula
...
-- Use the Hill system for writing chemical formulas. C then H followed by
...
instance ChemicalMass ChemicalFormula where
